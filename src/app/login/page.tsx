    ...
    <div className="min-h-screen bg-white flex items-center justify-center">
      <div className="w-full max-w-md px-8">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 font-bold text-gray-900 text-xl mb-6">
            <span>📄</span> ProposalDrop
          </Link>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/login" className="text-indigo-600 hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  )
